          ...
          builder: (context, child) {
            ...
            return StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                ...
                // Lógica para permitir Admin acessar mesmo em manutenção (opcional)
                // final user = FirebaseAuth.instance.currentUser;
                // final isAdmin = user?.email == dotenv.env['ADMIN_EMAIL']; 
                // if (emManutencao && !isAdmin) return const ManutencaoView();
